...
export default function Info({ globalData, archiveData, }) {
  ...
  return (
    <div
      className='fixed top-0 left-0 w-screen h-screen overflow-y-scroll py-12 px-2'
			style={{
		...
		>
			<div className='sticky top-0 bg-white z-10 h-12'></div>
			<Archive archiveData={ archiveData } />
      <div className=' py-12 px-2 uppercase'>
        {/* {
