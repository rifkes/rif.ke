    ...
    <div>
      ...
      <SetGlobalProps { ...{ globalData } } />
        {
          ...
          <motion.h1
            key='title'
            className='select-none fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 text-center p-2 ui-text'
            { ...fadeInOutVariants }
          >
            { titleText }
          </motion.h1>
        }
      {
        ...
        <button
          ...
          className='select-none fixed top-0 left-1/2 -translate-x-1/2 p-2 uppercase ui-text z-[999] cursor-pointer'
        >
      ...
      }
			{
				...
				<button
					...
					className='select-none block fixed bottom-0 left-1/2 -translate-x-1/2 pointer-events-all cursor-pointer p-2 uppercase ui-text z-[999]'
				>
					scroll
				</button>
			}
