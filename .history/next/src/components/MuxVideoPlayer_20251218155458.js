...
const MuxVideoPlayer = (props) => {
	...
	return (
		...
		>
			...
			<div
				ref={scrubVisualiser}
				className='absolute top-0 opacity-0 mouse:group-hover:opacity-100 touch:group-active:opacity-100 left-0 w-full h-[4px] bg-white mix-blend-difference opacity-0 transition-opacity duration-300 pointer-events-none'
				style={{
