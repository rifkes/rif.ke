...
const MuxVideoPlayer = (props) => {
	...
	return (
		<div
			className='w-full h-full top-0 bg-black relative'
		>
			...
			<div
				ref={scrubVisualiser}
				className='absolute top-0 left-0 w-[1px] h-full bg-white mix-blend-difference opacity-0 transition-opacity duration-300 pointer-events-none'
				style={{
