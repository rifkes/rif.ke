	...
	return (
		<div className='pb-12'>
			<div className='sticky top-0 bg-white z-10 pt-12 px-2'>
				...
				{
					<div className='grid grid-cols-3 md:grid-cols-4 gap-4 w-full top-0 bg-white z-10 pt-4'>

						<button
							className='flex justify-between gap-4 text-left cursor-pointer col-span-2 md:col-span-1'
							onClick={() => {
								if (orderBy === 'title') {
						...
						>
							{
								windowWidth >= 1200 ? 'title' : 'title, client'
							}
						</button>
