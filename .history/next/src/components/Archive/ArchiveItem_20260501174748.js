				...
				<div className='pl-8 w-full col-span-3 md:col-span-4'>
					{
						...
						<p className='grid grid-cols-4 sm:block gap-4'>
							<span className='col-span-1 sm:col-span-1 max-sm:block inline-block'>type: </span>
					...
					}
					{
						item.tools?.length > 0 &&
						<p className='grid grid-cols-4 sm:block gap-4'>
							<span className='col-span-1 sm:col-span-1 max-sm:block inline-block'>tools: </span>
					...
					}
					{
						item.role?.length > 0 &&
						<p className='grid grid-cols-4 sm:block gap-4'>
							<span className='col-span-1 sm:col-span-1 max-sm:block inline-block'>role: </span>
					...
					}
					{
						...
						<p className='grid grid-cols-4 sm:block gap-4'>
							<span className='col-span-1 sm:col-span-1 max-sm:block inline-block'>credits: </span>
