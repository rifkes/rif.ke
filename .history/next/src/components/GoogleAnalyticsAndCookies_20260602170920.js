				...
				<AnimatePresence>
					{
						...
						>
							<div className='max-w-lg z-[99999] bg-black text-white p-4'>
								<p className='text-pretty'>{globalData?.settings?.cookieConsentText?.length > 0 ? globalData?.settings?.cookieConsentText : 'By using this site you consent to the use of cookies.'}</p>
