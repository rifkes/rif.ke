	...
	return (
		<div>
			...
			<div className='table-container'>
			{
					...
					console.log(item?.image?._ref, item?.thumbnailTypeIsVideo),
					((showItemsWithoutVideoOrImage && ((!item?.video?._ref && item?.thumbnailTypeIsVideo) || (!item?.image?._ref && !item?.thumbnailTypeIsVideo))) || !showItemsWithoutVideoOrImage) &&	
