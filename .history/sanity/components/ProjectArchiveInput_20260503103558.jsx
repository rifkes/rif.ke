...
const ProjectArchiveInput = (props) => {
	...
	return (
		<div>
			...
			<button onClick={() => setShowItemsWithoutVideoOrImage(!showItemsWithoutVideoOrImage)}>Show items without video or image</button>

			{
				showItemsWithoutVideoOrImage &&
				<div className=''>{itemsWithoutVideoOrImage.join(', ')}</div>
			}
