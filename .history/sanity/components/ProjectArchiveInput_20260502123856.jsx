...
const ProjectArchiveInput = (props) => {
	...
	// console.log('members length:', props.members.length)
	// console.log('value length:', props.value.length)
	// console.log('members[0].kind:', props.members[0].kind)
	// console.log('members[0].key:', props.members[0].key)
	// console.log('value[0]._key:', props.value[0]._key)
			...
			<button
				onClick={() => {
					...
					for (let i = 0; i < newValues.length; i++) {
						newValues[i].image = undefined;
						newValues[i].video = undefined;
					}
					onChange(set(newValues));
				}}
			>
