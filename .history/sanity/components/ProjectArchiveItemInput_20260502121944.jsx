...
const ProjectArchiveItemInput = ({ fields, item, index, setValue, removeItem, expandedIndex, setExpandedIndex, onItemExpand, members, }) => {
										...
										field.type === 'mux.video' ?
											<div>
												<label>{field.title}:</label>
													...
													<button
														onClick={() => {
															onItemOpen([{_key: members[index].key}])
														}}
												>
													{item[field.name]?.asset?._ref ?
														'Edit video ↗':
