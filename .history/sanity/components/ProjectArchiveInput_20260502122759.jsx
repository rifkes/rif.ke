...
const ProjectArchiveInput = (props) => {
	...
	const { value, onChange, onItemExpand, members, renderDefault, } = props;

	const [expandedIndex, setExpandedIndex] = useState(null);

	console.log('member[0].item.members[8]:', Object.keys(props.members[0].item.members[8]))
console.log('member[0].item.members[8] name?:', props.members[0].item.members[8].name)
console.log('member[0].item.members[8] kind?:', props.members[0].item.members[8].kind)
	
	console.log('member[0].item keys:', Object.keys(props.members[0].item))
	console.log('member[0].item.members?', props.members[0].item.members?.map(m => m.name))
