...
const ProjectArchiveItemInput = ({ fields, item, index, setValue, removeItem, expandedIndex, setExpandedIndex, onItemExpand, members, member, renderPreview, renderField, renderInput, renderItem, }) => {
